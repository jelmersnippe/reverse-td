...
void Update(GameState& state) {
    ...
    ui.text("txt_pause", player != nullptr ? "YOU WON" : "GAME OVER", {.font_size = 40});
...
const Scene GAME_OVER_SCENE = {
    .name = "Game Over", .init = nullptr, .update = Update, .draw = Draw, .destroy = nullptr};
